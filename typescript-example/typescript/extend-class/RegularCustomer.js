...
var RegularCustomer = /** @class */ (function (_super) {
    ...
    function RegularCustomer(customerId, firstName, lastName, email, customerType, rank, address) {
...
var john = new RegularCustomer(uuid_1.v4(), 'John', 'Doe', 'joe@example.com', CustomerType_1.CustomerType.PERMANENT, "Valued Customer", "proddutur");
john.displayDetails();
